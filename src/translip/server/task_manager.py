...
def _build_pipeline_request(task: Task) -> PipelineRequest:
    ...
    return PipelineRequest(
        ...
        vision_backend=cfg.get("vision_backend", "auto"),
        vision_frames_per_unit=int(cfg.get("vision_frames_per_unit", 4)),
        vision_lang=cfg.get("vision_lang", "zh"),
        commentary_style=cfg.get("commentary_style", "plot_recap"),
        commentary_genre=cfg.get("commentary_genre", "剧情"),
        commentary_original_sound_ratio=int(cfg.get("commentary_original_sound_ratio", 20)),
        ...
        commentary_tone_preset=cfg.get("commentary_tone_preset", "objective"),
        commentary_pacing_preset=cfg.get("commentary_pacing_preset", "balanced"),
        commentary_perspective=cfg.get("commentary_perspective", "third_person"),
        commentary_audience=cfg.get("commentary_audience", "generic"),
        commentary_style_intensity=float(cfg.get("commentary_style_intensity", 0.6)),
        ...
        expected_speakers=int(cfg.get("expected_speakers", 0)),
