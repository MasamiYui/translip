...
backends — STTN video inpainting (default) and big-LaMa single-frame inpainting
— driven by translip's own OCR ``detection.json``. This makes subtitle erasure
fully in-tree with no external sibling project.
