...
- Name: dubbing-editor.spec.ts >> dubbing editor issue interaction
- Location: tests/e2e/dubbing-editor.spec.ts:35:5
...
```
Error: page.goto: net::ERR_ABORTED at http://localhost:5173/tasks/task-20260430-164759/dubbing-editor
Call log:
  - navigating to "http://localhost:5173/tasks/task-20260430-164759/dubbing-editor", waiting until "load"
